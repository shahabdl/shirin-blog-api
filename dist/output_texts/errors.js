...
exports.EN = exports.TEXTS = void 0;
exports.TEXTS = [
...
exports.EN = {
    ...
    INGREDIENT_NOT_EXISTS_WITH_THIS_ID: "ingredient with this ID does not exist, provide a name instead of id to create new one!",
